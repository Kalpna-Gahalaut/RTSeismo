function [D3]=ppdiffusion_p(FNAM,L1,M1,Z1,C1,Tdisc1,SC1,Xobs1,Yobs1,Xdisc1,Ydisc1,nt1,damhmsl1)
            L=L1;
            M=M1;
            Z=Z1;
            C=C1;
...
writematrix(D3,'ppdiffusion_result_p.dat');
end
