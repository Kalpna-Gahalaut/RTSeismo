function [D2]=stress_p(FNAM,L1,M1,Z1,C1,Tdisc1,SC1,Xobs1,Yobs1,Xdisc1,Ydisc1,nt1,damhmsl1)
           %global Xobs
           %global Yobs
           %global Xdisc
           %global Ydisc
...
for I=1:N 
  ...
  if (J==1&&K==1)
	D2=[sigax sigay sigaz tayaxy tayayz tayazx];
else
    D2=[D2
...
writematrix(D2,'stress_result_p.dat');
end
